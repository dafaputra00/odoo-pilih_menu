odoo.define('pos_dapur_order.models', function(require) {
    "use strict";
    ...
    models.load_models({
        model: 'dapur.order',
        fields: ['name', 'state_dapur', 'create_date', 'lines', 'state', 'length'],
        domain: [
            ['state', '=', 'draft']
        ],
    ...
    models.PosModel = models.PosModel.extend({
        _save_to_server: function(orders, options) {
            ...
            options = options || {};
            var self = this;
            var fields = _.find(this.models, function(model) { return model.model === 'dapur.order'; }).fields;
